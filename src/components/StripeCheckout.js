...
const CheckoutForm = () => {
  ...
  {
    succeeded ? <article>
      <h4>Thank You from ComfySloth!</h4>
    ...
    <article>
      ...
      <p>Test Card Number : 4242 4242 4242 4242 with any expiration, CVC, and postal code. </p>
    </article>
  }
  <form id="payment-form" onSubmit={handleSubmit}>
    ...
    {/* show a success message when successful */}
    <p className={succeeded ? "result-message" : "result-message hidden"}>
      Payment successful, see the result in your <a href="https://dashboard.stripe.com/test/payments">Stripe dashboard.</a>
